package dev.practice.coupling.phase2;
...
public class IntegrationTest {
    ...
    void registerMember() throws Exception {
        ...
        assertThat(savedEmailHistory.get(0).getMessage()).isEqualTo(name + ", Thank you for using our service! (phase 2)");
